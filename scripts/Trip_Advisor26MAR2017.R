...
write.table(full_reviews,paste("C:/Users/steve/Desktop/",Airline_Name_tx,".txt",sep = ''),sep = "|")
...
write.table(full_reviews_final,paste("C:/Users/steve/Desktop/All_Airlines_",toupper(format(Sys.Date(),"%d%b%Y")),".txt",sep = ''),sep = "||")
